...
#                        __________XXZ-model ALL-TO-ALL adiabatic evolution___________
# 

# In this script we implement the adiabatically-assited VQE for the XXZ model using an all-to-all, trotterized XX ansatz.
            ...
            for layer in range(layers):
                for i in range(N):
                    for j in range(i+1,N):
                        ...
                        qml.IsingXY(gamma[layer],wires=[i,j])
                for i in range(N):

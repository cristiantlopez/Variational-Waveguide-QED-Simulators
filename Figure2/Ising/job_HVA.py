...
# 
# In this script we implement the HVA to an Ising model.
...
# 4. final_energy_list : multidimensional array containing /mnt/netapp1/Store_CSIC//home/csic/qia/ctl/Variational_Waveguide/paper/figure1/'
...
def save(output,simulation_parameters):
    ...
    store_dir = './' # you must introduce a directory to store the data
    import pickle 
    name = 'HVA_adiab' # i will name it like this
...
def optimization(simulation_parameters,max_iterations,conv_tol,step_size,xi_list,gamma_list):
    ...
    initial_params = [thetasz,gamma_val]

...
# 
# In this script we implement an adiabatically assisted VQE with a brick-layer ansatz with entangling CZ gates
...
def optimization(simulation_parameters,max_iterations,conv_tol,step_size,xi_list,gamma_list):
    ...
    thetasy = 0.01*2*pi*random.uniform(key, shape=(2*N*layers+N,))
    initial_params = [thetasy]

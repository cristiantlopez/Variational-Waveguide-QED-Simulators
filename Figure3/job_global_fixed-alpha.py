...
def optimization(simulation_parameters,max_iterations,conv_tol,step_size,xi_list,gamma_list):
    ...
    def interaction(x):
        ...
        return 1/(power(x,float(alpha)))
    n=2 # number of exponentials used in the approximation
    sol = approximating_exp(interaction,N,n,True)
